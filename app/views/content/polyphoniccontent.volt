<html>
    <head>
        ...
        <title>Polyphonic Content</title>
                        ...
                        <li class="active treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active treeview">
                                    ...
                                    <ul class="treeview-menu">
                                        <li class="active"><a href="polyphoniccontent"><i class="fa fa-pencil-square-o"></i> Content</a></li>
                        ...
                        <section class="content">
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Upload Polyphonic</h3>
                                </div>
                                <!--box body start-->
                                <div class="box-body">

                        ...
                        <li class="active treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active treeview">
                                    ...
                                    <ul class="treeview-menu">
                                        <li class="active"><a href="themescontent"><i class="fa fa-pencil-square-o"></i> Content</a></li>
                                ...
                                <div class="box-body">
                                    <form class="form-horizontal">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <div class="col-md-2">
                                                    <label>File Preview (JPG/GIF)</label>
                                                </div>
                                                <div class="col-md-10">
                                                    <div class="col-md-4">
                                                        <input type="file" id="exampleInputFile">

<html>
    <head>
        ...
        <title>Animated Picture Content</title>
                        ...
                        <li class="active treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active treeview">
                                    ...
                                    <ul class="treeview-menu">
                                        <li class="active"><a href="animatedcontent"><i class="fa fa-pencil-square-o"></i> Content</a></li>
                        ...
                        <section class="content">
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Upload Animated Picture</h3>
                                </div>
                                <!--box body start-->
                                <div class="box-body">
                                    <form class="form-horizontal">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <button type="button" class="btn btn-info" data-toggle="collapse" data-target="#demo" style="margin-left: 15px;">Show Categories</button>
                            ...
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Color Picture List</h3>
                                </div>
                                <!--box body start-->
                                <div class="box-body">
                                    <form class="form-horizontal">
                                        ...
                                        <table id="example2" class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>26 Mar 2017</td>
                                                    <td>GMS</td>
                                                    <td><img src="../dist/img/photo1.png" style="max-height: 40px;"></td>
                                                    <td>http://bit.ly/2mD9GEZ</td>
                                                    <td>

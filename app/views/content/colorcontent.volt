<html>
    <head>
        ...
        <title>Color Picture Content</title>
                        ...
                        <li class="active treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active treeview">
                                    ...
                                    <ul class="treeview-menu">
                                        <li class="active"><a href="colorcontent"><i class="fa fa-pencil-square-o"></i> Content</a></li>
                        ...
                        <section class="content">
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Upload Color Picture</h3>
                                </div>
                                <!--box body start-->
                                <div class="box-body">

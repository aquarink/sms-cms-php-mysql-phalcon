                        ...
                        <li class="active treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active treeview">
                                    ...
                                    <ul class="treeview-menu">
                                        <li class="active"><a href="javaappcontent"><i class="fa fa-pencil-square-o"></i> Content</a></li>
                        ...
                        <section class="content">
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Upload Java App</h3>
                                </div>
                                <!--box body start-->
                                <div class="box-body">
                            ...
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Java App List</h3>
                                </div>
                                <!--box body start-->
                                <div class="box-body">
                                    <form class="form-horizontal">

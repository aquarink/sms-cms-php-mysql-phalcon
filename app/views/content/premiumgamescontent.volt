<html>
    <head>
        ...
        <title>Premium Game Content</title>
                        ...
                        <li class="active treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active treeview">
                                    ...
                                    <ul class="treeview-menu">
                                        <li class="active"><a href="premiumcontent"><i class="fa fa-pencil-square-o"></i> Content</a></li>
                        ...
                        <section class="content">
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Upload Premium Game</h3>
                                </div>
                                <!--box body start-->
                                <div class="box-body">
                            ...
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Premium Game List</h3>
                                </div>
                                <!--box body start-->
                                <div class="box-body">
                                    <form class="form-horizontal">

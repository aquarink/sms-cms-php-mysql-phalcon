<html>
    <head>
        ...
        <title>Manage WAP Content</title>
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active treeview">
                                    ...
                                    <ul class="treeview-menu">
                                        ...
                                        <li class="active"><a href="managewap"><i class="fa fa-list"></i> Manage Content</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;max-width: 20px;">
                                                        <img src="../dist/img/photo1.png" style="max-width:100px;" /><br>
                                                        aaaaa
                                                    </td>

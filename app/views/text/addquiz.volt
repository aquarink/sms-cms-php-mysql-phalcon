                        ...
                        <li class="active treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active treeview">
                                    ...
                                    <ul class="treeview-menu">
                                        <li class="active"><a href="addquiz"><i class="fa fa-pencil-square-o"></i> Add New</a></li>
                                ...
                                <div class="box-body">
                                    <form class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 col-md-offset-2">Question</label>
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 col-md-offset-2">Answer</label>
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 col-md-offset-2">Point True</label>

                                            <div class="col-sm-5">
                                                <input type="text" class="form-control" placeholder="Point True">
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-sm-2 col-md-offset-2">Point False</label>

                                            <div class="col-sm-5">
                                                <input type="text" class="form-control" placeholder="Point False">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control" placeholder="Publish Seq" >
                                            </div>
                                        </div>

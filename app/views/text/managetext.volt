<html>
    <head>
        ...
        <title>Manage Text Content</title>
                        ...
                        <li class="active treeview">
                            ...
                            <ul class="treeview-menu">
                                <li class="active treeview">
                                    ...
                                    <ul class="treeview-menu">
                                        <li><a href="addtext"><i class="fa fa-pencil-square-o"></i> Add New</a></li>
                                        <li class="active"><a href="managetext"><i class="fa fa-list"></i> Manage Content</a></li>
                                    </ul>
                                </li>
                                <li class="treeview">
                                ...
                                <div class="box-body">
                                    <form class="form-horizontal">
                                        ...
                                        <table id="example2" class="table table-bordered table-hover">
                                            ...
                                            <tbody>
<!--                                                <tr>
                                                    <td style="text-align: center">Reg Tawa</td>
                                                    <td style="text-align: center;max-width: 20px;"></td>
                                                    <td>Pak, gmn caranya jd org baik?| kita hrs brada di jalan kebenaran| tp jalan itu ga ada di gugel maps, pak</td>
                                                    <td style="text-align: center;width: 50px;">2017-05-07 00:00:00</td>
                                                    <td style="text-align: center;max-width: 20px;">1</td>
                                                    <td style="text-align: center;width: 50px;">2017-04-17 13:18:13</td>
                                                    <td style="text-align: center;width: 50px;"><a href="">EDIT</a></td>
                                                    <td style="text-align: center;width: 50px;"><a href="">DELETE</a></td>
                                                ...
                                                {% for d in data %}
                                                <tr>
                                                    <td style="text-align: center">{{ d['app_desc'] }}</td>
                                                    <td style="text-align: center;max-width: 20px;">{{ d['category'] }}</td>
                                                    <td>{{ d['content_field'] }}</td>
                                                    <td style="text-align: center;width: 50px;">{{ d['publish_date'] }}</td>
                                                    <td style="text-align: center;max-width: 20px;">{{ d['content_number'] }}</td>
                                                    <td style="text-align: center;width: 50px;">{{ d['content_create'] }}</td>
                                                    <td style="text-align: center;width: 50px;"><a href="">EDIT</a></td>
                                                    <td style="text-align: center;width: 50px;"><a href="deleteText/{{ d['id_content'] }}">DELETE</a></td>
                                                </tr>
                                                {% endfor %}
                                            </tbody>
                                        </table>

<html>
    <head>
        ...
        <title>Manage Quiz Content</title>
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active treeview">
                                    ...
                                    <ul class="treeview-menu">
                                        ...
                                        <li class="active"><a href="managequiz"><i class="fa fa-list"></i> Manage Content</a></li>
                                    </ul>
                                </li>
                                <li class="treeview">
                                        ...
                                        <table id="example2" class="table table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="text-align: center">POINT TRUE</th>
                                                    <th style="text-align: center">POINT FALSE</th>
                                                    <th style="text-align: center">PUBLISH DATE</th>
                                                    <th style="text-align: center">PUBLISH SEQ</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;max-width: 20px;">B</td>
                                                    <td style="text-align: center;max-width: 20px;">20</td>
                                                    <td style="text-align: center;max-width: 20px;">0</td>

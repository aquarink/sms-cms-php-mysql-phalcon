<html>
    <head>
        ...
        <title>Add New WAP Content</title>
                        ...
                        <li class="active treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active treeview">
                                    ...
                                    <ul class="treeview-menu">
                                        <li class="active"><a href="addwap"><i class="fa fa-pencil-square-o"></i> Add New</a></li>
                                ...
                                <div class="box-body">
                                    <form class="form-horizontal">
                                        ...
                                        <div class="form-group" style="margin-top:15px;">
                                            <label class="col-sm-2 col-md-offset-1">Service</label>
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 col-md-offset-1">Content</label>
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 col-md-offset-1">Category</label>
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 col-md-offset-1">Publish Date</label>
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 col-md-offset-1">Publish Seq</label>

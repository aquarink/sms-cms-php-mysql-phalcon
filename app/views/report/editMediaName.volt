                                    ...
                                    <form class="form-horizontal" style="margin-top:25px;" method="post">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="col-md-4">
                                                        <input type="text" class="form-control" name="code_media" value="{{ detail['code_media'] }}" placeholder="MEDIA CODE">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="col-md-4">
                                                        <input type="text" class="form-control" name="name_media" value="{{ detail['name_media'] }}" placeholder="MEDIA">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

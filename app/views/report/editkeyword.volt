                                    ...
                                    <form class="form-horizontal" style="margin-top:25px;" method="post">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="col-md-4">
                                                        <input type="text" class="form-control" name="keyword" value="{{ detail['keyword'] }}" placeholder="KEYWORD">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-md-10">
                                                    <div class="col-md-4">
                                                        <select class="form-control" name="telco">
                                                            <option value="tsel" <?php if( $detail['keyword_telco'] == 'tsel'){ echo 'selected';} ?> >Telkomsel</option>
                                                            <option value="xl" <?php if( $detail['keyword_telco'] == 'xl'){ echo 'selected';} ?> >XL</option>
                                                            <option value="isat" <?php if( $detail['keyword_telco'] == 'isat'){ echo 'selected';} ?> >Indosat</option>
                                                            <option value="hutch" <?php if( $detail['keyword_telco'] == 'hutch'){ echo 'selected';} ?> >Hutch</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-10">
                                                    <div class="col-md-4">
                                                        <select class="form-control" name="shortcode">
                                                            <option value="95000" <?php if( $detail['shortcode'] == '95000'){ echo 'selected';} ?> >95000</option>
                                                            <option value="96000" <?php if( $detail['shortcode'] == '96000'){ echo 'selected';} ?> >96000</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-10">
                                                    <div class="col-md-4">
                                                        <select class="form-control" name="keyword_status">
                                                            <option value="1" <?php if( $detail['keyword_status'] == '1'){ echo 'selected';} ?> >Aktif</option>
                                                            <option value="2" <?php if( $detail['keyword_status'] == '2'){ echo 'selected';} ?> >Non Aktif</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>

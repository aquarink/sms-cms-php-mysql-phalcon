    ...
    <body  class="hold-transition skin-blue sidebar-mini">
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="active treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="moreg"><i class="fa fa-circle-o"></i> MO REG</a></li>
                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    <p style="color:#446CB3">
                                        MO STAT : [ Tanggal : 2017-06-05 ] [ SHORTCODE : All ] [ TELCO : All ] [ Service : All ]
                                    </p>
                                </div>
                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="background-color: rgba(34, 167, 240,0.8);color: #fff;">44</td>
                                                <td style="background-color: rgba(34, 167, 240,0.8);color: #fff;">55</td>
                                                <td style="background-color: rgba(34, 167, 240,0.8);color: #fff;">66</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
        ...
        <script>
            Highcharts.chart('container', {
                ...
                title: {
                    text: 'Grafik MO Reg/Unreg Perjam',
                    style: {
                        color: '#fff'

                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="active treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="medianame"><i class="fa fa-circle-o"></i> MEDIA NAME</a></li>
                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body" style="overflow-x:auto">
                                    <table id="example2" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th style="text-align: center">MEDIA ID</th>
                                                <th style="text-align: center">MEDIA CODE</th>
                                        ...
                                        <tbody>
                                            {% for d in data %}
                                            <tr>
                                                <td style="text-align: center">{{ d['id_media'] }}</td>
                                                <td style="text-align: center">{{ d['code_media'] }}</td>
                                                <td style="text-align: center">{{ d['name_media'] }}</td>
                                                <td style="text-align: center">{{ d['create_media'] }}</td>
                                                <td style="text-align: center"><a href="{{ config.base_url }}report/editMedia?id={{ d['id_media'] }}">EDIT</a></td>
                                                <td style="text-align: center"><a href="deleteMedia/{{ d['id_media'] }}">DELETE</a></td>
                                            </tr>
                                            {% endfor %}
                                        </tbody>
                                    </table>
                                    ...
                                    <form class="form-horizontal" style="margin-top:25px;" method="post">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="col-md-4">
                                                        <input type="text" class="form-control" name="code_media"  placeholder="MEDIA CODE">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="col-md-4">
                                                        <input type="text" class="form-control" name="name_media" placeholder="MEDIA">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

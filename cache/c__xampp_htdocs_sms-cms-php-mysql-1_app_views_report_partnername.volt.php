                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center"><a href="<?= $this->config->base_url ?>report/editpartner?id=<?= $d['id'] ?>"><i class="fa fa-pencil"></i></a></td>
                                    ...
                                    <form class="form-horizontal" style="margin-top:25px;" method="post">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="col-md-4">
                                                        <input type="text" class="form-control" name="name_partner"  placeholder="PARTNER">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

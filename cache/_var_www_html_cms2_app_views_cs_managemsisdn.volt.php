                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="active treeview">
                            ...
                            <ul class="treeview-menu">
                                <li class="active"><a href="managemsisdn"><i class="fa fa-mobile"></i> Check MSISDN</a></li>
                                <li><a href="blacklistmsisdn"><i class="fa fa-list-ol"></i> Blacklist MSISDN</a></li>
                            </ul>
                        </li>
                        ...
                        <div class="col-md-12">
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Check MSISDN</h3>
                                </div>
                                <div class="box-body">
                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align: center">DATE UNREG</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="text-align: center">100001 - Reg Bola</td>
                                                ...
                                                <td style="text-align: center">2014-04-04 09:00:00</td>
                                                <td style="text-align: center">Tidak Aktif</td>
                                                <td style="text-align: center">
                                                    <!--                                                    <button type="submit" class="btn btn-primary" style="width:78px;">
                                                                                                            <i class="fa fa-pencil-square-o" aria-hidden="true" style="margin-right: 3px;"></i>
                                                                                                        </button>
                                            ...
                                            <tr>
                                                <td style="text-align: center">100001 - Reg Main</td>
                                                <td style="text-align: center">628787878787</td>
                                                <td style="text-align: center">99999</td>
                                                <td style="text-align: center">2017-04-04 00:09:24</td>
                                                ...
                                                <td style="text-align: center">
                                                    <button type="submit" class="btn btn-primary" style="width:78px;">
                                                        <i class="fa fa-pencil-square-o" aria-hidden="true" style="margin-right: 3px;"></i>Unreg
                                                    </button>
